...
public class Select_Aircraft 
{
	...
	public void Select()
	{
		...
		if(_Simulator.Get_Key().Get_Select(13))
		{
			_Simulator.Get_Aircraft(0).x=200;
			_Simulator.Get_Aircraft(0).y=500;
			_Simulator.Get_Aircraft(0).Knots=200;
			_Simulator.Get_Aircraft(0).Altitude=5000;
			_Simulator.Get_Aircraft(0).HDG=90;
			_Simulator.Get_Aircraft(1).x=400;
			_Simulator.Get_Aircraft(1).y=700;
			_Simulator.Get_Aircraft(1).Knots=200;
			_Simulator.Get_Aircraft(1).Altitude=5000;
			_Simulator.Get_Aircraft(1).HDG=360;
		}
		
		if(_Simulator.Get_Key().Get_Select(14))
		{
			_Simulator.Get_Aircraft(0).x=63;
			_Simulator.Get_Aircraft(0).y=300;
			_Simulator.Get_Aircraft(0).Knots=160;
			_Simulator.Get_Aircraft(0).Altitude=1000;
			_Simulator.Get_Aircraft(0).HDG=120;
